...
export const chatbotIcon = `//android.widget.ImageView[@resource-id="org.samagra.missionPrerna:id/bot_icon"]`;
...
export const teacherName = `//android.widget.TextView[@resource-id="org.samagra.missionPrerna:id/tv_name"]`;
export const uside = `//android.widget.TextView[@resource-id="org.samagra.missionPrerna:id/tv_designation"]`;
export const district = `//android.widget.TextView[@resource-id="org.samagra.missionPrerna:id/tv_district"]`;
export const block = `//android.widget.TextView[@resource-id="org.samagra.missionPrerna:id/tv_block"]`;
export const teacherAnkalanSaransh = `//android.widget.TextView[@resource-id="org.samagra.missionPrerna:id/tvSummaryLabel"]`;
...
export const countNipunStudentsInMonth = `(//android.widget.TextView[@resource-id="org.samagra.missionPrerna:id/labelTextView"])[4]`;
