...
export const mobileNumberInputBox = `//android.widget.EditText[@resource-id="org.samagra.missionPrerna:id/etResult"]`;

export const sendOtpButton = `//android.widget.Button[@resource-id="org.samagra.missionPrerna:id/btnCollect"]`;
